    ...
    <div class="panel panel-primary">
        ...
        <form method="post" action="{{url('admin/save-product')}}" enctype="multipart/form-data">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">                
                    <textarea style="width:100%" name="product_description" id="" cols="30" rows="10"></textarea>
                </div>
            </div>          
            <div class="row" style="margin-top:5px;">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="" name="product_price" class="form-control" required>
                </div>
            </div>
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2">Giảm giá</div>
                <div class="col-md-10">
                    <input type="text" value="" name="product_discount" class="form-control" required>
                </div>
            </div>
            <div class="row" style="margin-top:5px;">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="" name="product_sale" class="form-control" required>
                </div>
            </div>
            <div class="row" style="margin-top:5px;">
